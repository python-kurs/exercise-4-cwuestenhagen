...
main_dir = Path("C:/Users/coral/Documents/GitHub/exercise-4-cwuestenhagen/")
...
create_climate_diagram(df=garmisch_agg, temp_col=" TMK", prec_col=" RSK", title="Garmisch-Partenkirchen \n 47°29'N/11°05'E", 
                       filename= output_dir /"Garmisch-Partenkirchen.png", temp_min = -15, temp_max = 20, prec_min = 0, prec_max = 370)
create_climate_diagram(df=zugspitze_agg, temp_col=" TMK", prec_col=" RSK", title="Zugspitze \n 47°25'N/10°59'E", 
                       filename= output_dir /"Zugspitze.png", temp_min = -15, temp_max = 20, prec_min = 0, prec_max = 370)
